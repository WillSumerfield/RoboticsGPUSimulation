...
HAND_CFG = ArticulationCfg(
    ...
    init_state=ArticulationCfg.InitialStateCfg(
        pos=(0.0, 0.0, 2.5), joint_pos={"joint_right": 0.0, "joint_left": 0.0, "joint_back": 0.0, "joint_slide_x": 0.0, "joint_slide_y": 0.0, "joint_slide_z": 2.0}
    ),
    actuators={
...
SENSOR_CFG = ContactSensorCfg(
    track_air_time=True,
    #filter_prim_paths_expr=["/World/envs/env_.*/Robot/Object1", "/World/envs/env_.*/Robot/Object2"],
)
...
@configclass
class GraspObjectsEnvCfg(DirectRLEnvCfg):
    # env
    n_timesteps = 1000
    decimation = 2
    ...
    # objects
    object1_cfg: RigidObjectCfg = OBJ_CFG.replace(prim_path="/World/envs/env_.*/Robot/Object1")
    object1_cfg.init_state.pos = (0.0, -0.35, 0.255)
    object2_cfg: RigidObjectCfg = OBJ_CFG.replace(prim_path="/World/envs/env_.*/Robot/Object2")
    object2_cfg.init_state.pos = (0.0, 0.35,  0.255)

    # custom parameters/scales
    # - robot body and joint names
    hand_body_name = "palm"
    object1_body_name = "Object1"
    object2_body_name = "Object2"
    ...
    rew_scale_lifted_single = 5.0
    rew_scale_lifted_double = 20.0

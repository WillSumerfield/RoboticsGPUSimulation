...
OBJ_CFG = RigidObjectCfg(
    prim_path="/World/envs/env_.*/Robot/object_group/Object",
...
HANDLE_CFG = RigidObjectCfg(
    prim_path="/World/envs/env_.*/Robot/object_group/Handle1",
    init_state=RigidObjectCfg.InitialStateCfg(
        pos=(0.55, 0.0, 0.70),
        rot=(1.0, 0.0, 0.0, 0.0),
        lin_vel=(0.0, 0.0, 0.0),
...
@configclass
class GraspPotEnvCfg(DirectRLEnvCfg):
    # env
    n_timesteps = 1000
    decimation = 2
    ...
    handle1_cfg: RigidObjectCfg = HANDLE_CFG
    handle2_cfg: RigidObjectCfg = HANDLE_CFG.replace(prim_path="/World/envs/env_.*/Robot/object_group/Handle2")
    handle2_cfg.init_state.pos = (-0.55, 0.0, 0.70)
